...
const usePlayerState = ({ autoplay, muted })=>{
    // Basic player state - KORRIGIERT: isPlaying initial state
    const [isPlaying, setIsPlaying] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(autoplay); // Wenn autoplay true, dann playing
...
const usePlayerEffects = ({ mp4, webm, youtube, vimeo, btag, captions, description, chapters, playerState, cues, parsedChapters, videoRef, youtubeContainerRef, vimeoContainerRef })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const timeout = setTimeout(()=>{
            // Nur verstecken wenn Video noch läuft
    ...
    // Show controls on interaction - KORRIGIERT: Auch bei Pause sichtbar lassen
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const show = ()=>{
            playerState.setControlsVisible(true);
            // Bei Pause Controls dauerhaft sichtbar lassen
            if (!playerState.isPlaying) {
...
const FullPlayer = ({ mp4, webm, youtube, vimeo, btag, captions, description, chapters, autoplay = false, muted = true })=>{
    ...
    const hasCC = !!captions && captions.includes(`_${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LOCAL"]}.vtt`);
    const hasTranscript = !!description && description.includes(`_${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LOCAL"]}.vtt`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a291202._.js.map