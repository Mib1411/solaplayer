...
const usePlayerState = ({ autoplay, muted })=>{
    ...
    const [isPlaying, setIsPlaying] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(autoplay); // Wenn autoplay true, dann playing
...
_s(usePlayerState, "tLa+bl0nvYQ9tPX2IwKlTNEwWiI=");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "usePlayerEffects.useEffect": ()=>{
            ...
            const timeout = setTimeout({
                "usePlayerEffects.useEffect.timeout": ()=>{
                    // Nur verstecken wenn Video noch läuft
                    if (playerState.isPlaying) {
                        playerState.setControlsVisible(false);
                    }
                }
            }["usePlayerEffects.useEffect.timeout"], 3000);
            return ({
                "usePlayerEffects.useEffect": ()=>clearTimeout(timeout)
            })["usePlayerEffects.useEffect"];
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["usePlayerEffects.useEffect"], [
...
_s(usePlayerEffects, "V0PyFZFymxu+aV/aDecttuZNr2k=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0e01698._.js.map