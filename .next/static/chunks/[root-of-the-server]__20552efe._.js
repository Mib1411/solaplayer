...
const FullPlayer = ({ mp4, webm, youtube, vimeo, btag, captions, description, chapters, autoplay = false, muted = true // Standard: Ton aus
    ...
    const timeUpdateIntervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [showTranscript, setShowTranscript] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Nur wenn description in LOCAL verfügbar
    const [showCC, setShowCC] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Nur wenn captions in LOCAL verfügbar
    ...
    const [audioDescActive, setAudioDescActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Nur wenn description verfügbar
    ...
    const [vimeoPlayerId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(`vimeo-player-${Math.random().toString(36).substr(2, 9)}`);
    // Data hooks
                        ...
                        if (mp4 || webm) {
                            ...
                            if (mp4) {
                                ...
                                if (Array.isArray(mp4)) {
                                    sources.mp4 = mp4.map({
                                        "FullPlayer.useEffect.resolveVideoSource": (url, index)=>({
                                                url,
                            ...
                            try {
                                ...
                                ytPlayer.on('ready', {
                                    "FullPlayer.useEffect.initYouTubePlayer": ()=>{
                                        ...
                                        }["FullPlayer.useEffect.initYouTubePlayer"], 100);
                                    }
                                }["FullPlayer.useEffect.initYouTubePlayer"]);
                                ytPlayer.on('play', {
        ...
        "FullPlayer.useEffect": ()=>{
            if (playerType === 'vimeo' && vimeo) {
                const initVimeoPlayer = {
                    "FullPlayer.useEffect.initVimeoPlayer": async ()=>{
                        ...
                        if (vimeoContainerRef.current) {
                            ...
                            try {
                                const vimeoPlayer = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$vimeoPlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VimeoPlayerWrapper"](vimeoPlayerId, videoId);
                                ...
                                }["FullPlayer.useEffect.initVimeoPlayer"]);
                                vimeoPlayer.on('play', {
                                    "FullPlayer.useEffect.initVimeoPlayer": ()=>setIsPlaying(true)
                                }["FullPlayer.useEffect.initVimeoPlayer"]);
                                vimeoPlayer.on('pause', {
                                    "FullPlayer.useEffect.initVimeoPlayer": ()=>setIsPlaying(false)
                                }["FullPlayer.useEffect.initVimeoPlayer"]);
                                vimeoPlayer.on('ended', {
                                    "FullPlayer.useEffect.initVimeoPlayer": ()=>setIsPlaying(false)
                                }["FullPlayer.useEffect.initVimeoPlayer"]);
                                vimeoPlayer.on('timeupdate', {
                                    "FullPlayer.useEffect.initVimeoPlayer": (data)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FullPlayer.useEffect": ()=>{
            ...
            setShowCC(!!captions && captions.includes(`_${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL"]}.vtt`));
            // Transcript nur anzeigen wenn description in LOCAL verfügbar
            setShowTranscript(!!description && description.includes(`_${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL"]}.vtt`));
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    !isLoading && (playerType === 'video' || playerType === 'btag') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                        ref: videoRef,
                        width: "100%",
                        height: "400",
                    ...
                    !isLoading && playerType === 'youtube' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    !isLoading && playerType === 'vimeo' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    availableQualities.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            marginTop: 8,
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    controlsVisible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                        ...
                        children: [
                            ...
                            chapters && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "player-btn",
                            ...
                            (description || hasAudioTrack) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "player-btn",
                            ...
                            isPiPSupported && (playerType === 'video' || playerType === 'btag') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "player-btn",
                                onClick: handlePiP,
            ...
            settingsOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SettingsModal, {
                open: settingsOpen,
            ...
            infoOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InfoModal, {
                open: infoOpen,
...
_s(FullPlayer, "rzlYXMopOcHHZaLOTOENczd/yZQ=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20552efe._.js.map