    ...
    while(i < lines.length){
        ...
        if (/^\d{2}:\d{2}:\d{2}[\.,]\d{3}\s*-->\s*\d{2}:\d{2}:\d{2}[\.,]\d{3}/.test(lines[i])) {
            ...
            if (timeMatch) {
                ...
                // Text sammeln
                let text = '';
                while(i < lines.length && !/^\d{2}:\d{2}:\d{2}[\.,]\d{3}\s*-->/.test(lines[i]) && !/^\d+$/.test(lines[i]) && lines[i].trim() !== ''){
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useTranscriptData.useEffect": ()=>{
            const loadTranscript = {
                "useTranscriptData.useEffect.loadTranscript": async ()=>{
                    const allCues = [];
                    try {
                        // CAPTIONS laden
                        if (captions) {
                            const captionsText = await fetch(captions).then({
                                "useTranscriptData.useEffect.loadTranscript": (r)=>r.text()
                            }["useTranscriptData.useEffect.loadTranscript"]);
                            const captionCues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$videoUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseVtt"])(captionsText, 'caption');
                            allCues.push(...captionCues);
                        }
                        // DESCRIPTIONS laden  
                        if (description) {
                            const descText = await fetch(description).then({
                                "useTranscriptData.useEffect.loadTranscript": (r)=>r.text()
                            }["useTranscriptData.useEffect.loadTranscript"]);
                            const descCues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$videoUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseVtt"])(descText, 'description');
                            allCues.push(...descCues);
                        }
                        // Nach Zeit sortieren
                        allCues.sort({
                            "useTranscriptData.useEffect.loadTranscript": (a, b)=>a.startTime - b.startTime
                        }["useTranscriptData.useEffect.loadTranscript"]);
                        setCues(allCues);
                    } catch (error) {
...
"[project]/src/components/SettingsModal.module.css [app-client] (css module)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v({
  "checkbox": "SettingsModal-module__TCnG-q__checkbox",
  "checkboxContainer": "SettingsModal-module__TCnG-q__checkboxContainer",
  "checkboxLabel": "SettingsModal-module__TCnG-q__checkboxLabel",
  "closeButton": "SettingsModal-module__TCnG-q__closeButton",
  "errorMessage": "SettingsModal-module__TCnG-q__errorMessage",
  "label": "SettingsModal-module__TCnG-q__label",
  "modalContent": "SettingsModal-module__TCnG-q__modalContent",
  "modalOverlay": "SettingsModal-module__TCnG-q__modalOverlay",
  "modalTitle": "SettingsModal-module__TCnG-q__modalTitle",
  "rangeContainer": "SettingsModal-module__TCnG-q__rangeContainer",
  "rangeInput": "SettingsModal-module__TCnG-q__rangeInput",
  "section": "SettingsModal-module__TCnG-q__section",
  "sectionTitle": "SettingsModal-module__TCnG-q__sectionTitle",
  "select": "SettingsModal-module__TCnG-q__select",
  "testButton": "SettingsModal-module__TCnG-q__testButton",
});
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/SettingsModal.module.css [app-client] (css module)");
;
var _s = __turbopack_context__.k.signature();
;
;
const SettingsModal = ({ open, onClose, playerState })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsModal.useEffect": ()=>{
            if (open && 'speechSynthesis' in window) {
                const loadVoices = {
                    "SettingsModal.useEffect.loadVoices": ()=>{
    ...
    if (!open) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].modalOverlay,
        onClick: onClose,
        role: "dialog",
        "aria-modal": "true",
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            "data-modal": true,
            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].modalContent,
            onClick: (e)=>e.stopPropagation(),
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    id: "settings-title",
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].modalTitle,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].section,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].sectionTitle,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].label,
                            children: "Modus:"
                        }, void 0, false, {
                            fileName: "[project]/src/components/SettingsModal.tsx",
                            lineNumber: 98,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].select,
                            children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        playerState.voices && playerState.voices.length > 0 ? playerState.voices.map((v)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: v.voiceURI,
                                                children: [
                                                    v.name,
                                                    " (",
                                            ...
                                            disabled: true,
                                            children: "Stimmen werden geladen..."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/SettingsModal.tsx",
                                            lineNumber: 130,
                                            columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].rangeContainer,
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].label,
                                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].rangeInput
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/SettingsModal.tsx",
                                            lineNumber: 138,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].testButton,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].checkboxContainer,
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].checkboxLabel,
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "checkbox",
                                                    checked: playerState.autoStop || false,
                                                    onChange: (e)=>playerState.setAutoStop(e.target.checked),
                                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].checkbox
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/SettingsModal.tsx",
                                                    lineNumber: 159,
                                                    columnNumber: 19
                                ...
                                !playerState.ttsAvailable && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].errorMessage,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    onClick: onClose,
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SettingsModal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].closeButton,
                    children: "Schließen"
                }, void 0, false, {
                    fileName: "[project]/src/components/SettingsModal.tsx",
                    lineNumber: 228,
...
_s(SettingsModal, "+k7XijSvesBZslYclXvfsR/AuPY=");
_c = SettingsModal;
var _c;
...
"[project]/src/components/TranscriptSidebar.module.css [app-client] (css module)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v({
  "caption": "TranscriptSidebar-module__4kXxWW__caption",
  "current": "TranscriptSidebar-module__4kXxWW__current",
  "dark": "TranscriptSidebar-module__4kXxWW__dark",
  "description": "TranscriptSidebar-module__4kXxWW__description",
  "noContent": "TranscriptSidebar-module__4kXxWW__noContent",
  "transcriptContainer": "TranscriptSidebar-module__4kXxWW__transcriptContainer",
  "transcriptContent": "TranscriptSidebar-module__4kXxWW__transcriptContent",
  "transcriptHeader": "TranscriptSidebar-module__4kXxWW__transcriptHeader",
  "transcriptItem": "TranscriptSidebar-module__4kXxWW__transcriptItem",
  "transcriptList": "TranscriptSidebar-module__4kXxWW__transcriptList",
  "transcriptText": "TranscriptSidebar-module__4kXxWW__transcriptText",
  "transcriptTime": "TranscriptSidebar-module__4kXxWW__transcriptTime",
});
}}),
"[project]/src/components/TranscriptSidebar.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/TranscriptSidebar.module.css [app-client] (css module)");
;
;
const Transcript = ({ cues, currentCueIdx, visible, currentTime })=>{
    ...
    if (!cues || cues.length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptContainer,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptHeader,
                    children: "Transkript"
                }, void 0, false, {
                    fileName: "[project]/src/components/TranscriptSidebar.tsx",
                    lineNumber: 34,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].noContent,
                    children: "Kein Transkript verfügbar"
                }, void 0, false, {
                    fileName: "[project]/src/components/TranscriptSidebar.tsx",
                    lineNumber: 35,
                    columnNumber: 9
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptContent,
                children: visibleCues.length > 0 ? visibleCues.map((cue, idx)=>{
                    const originalIdx = cues.indexOf(cue);
                    const isCurrent = cue.startTime <= currentTime && cue.endTime >= currentTime;
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptItem} ${isCurrent ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].current : ''} ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"][cue.type] || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].description}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptTime,
                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].transcriptText,
                                children: cue.text
                            }, void 0, false, {
                                fileName: "[project]/src/components/TranscriptSidebar.tsx",
                                lineNumber: 71,
                    ...
                    children: [
                        ...
                        "Erstes Element bei: ",
                        cues[0] ? formatTime(cues[0].startTime) : 'N/A'
                    ]
                }, void 0, true, {
                    fileName: "[project]/src/components/TranscriptSidebar.tsx",
                    lineNumber: 78,
...
"[project]/src/components/ChaptersSidebar.module.css [app-client] (css module)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v({
  "chapterItem": "ChaptersSidebar-module__ojRHxa__chapterItem",
  "chapterTime": "ChaptersSidebar-module__ojRHxa__chapterTime",
  "chapterTitle": "ChaptersSidebar-module__ojRHxa__chapterTitle",
  "chaptersContainer": "ChaptersSidebar-module__ojRHxa__chaptersContainer",
  "chaptersHeader": "ChaptersSidebar-module__ojRHxa__chaptersHeader",
  "chaptersList": "ChaptersSidebar-module__ojRHxa__chaptersList",
  "current": "ChaptersSidebar-module__ojRHxa__current",
  "dark": "ChaptersSidebar-module__ojRHxa__dark",
});
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/ChaptersSidebar.module.css [app-client] (css module)");
;
;
const ChaptersSidebar = ({ chapters, currentChapterIdx, visible, onChapterClick })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chaptersContainer,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chaptersHeader,
                children: "Kapitel"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chaptersList,
                children: chapters.map((chapter, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chapterItem} ${idx === currentChapterIdx ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].current : ''}`,
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chapterTime,
                                children: formatTime(chapter.startTime)
                            }, void 0, false, {
                                fileName: "[project]/src/components/ChaptersSidebar.tsx",
                                lineNumber: 48,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChaptersSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].chapterTitle,
...
"[project]/src/components/PlayerSidebar.module.css [app-client] (css module)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v({
  "sidebarContainer": "PlayerSidebar-module__8L2Amq__sidebarContainer",
});
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/TranscriptSidebar.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/PlayerSidebar.module.css [app-client] (css module)");
;
;
;
;
const PlayerSidebar = ({ playerState, cues = [], parsedChapters = [], onChapterClick })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerSidebar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].sidebarContainer,
        children: [
            hasTranscript && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TranscriptSidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transcript"], {
...
__turbopack_context__.v({
  ...
  "sidebarArea": "PlayerContainer-module__IInhMG__sidebarArea",
  "videoArea": "PlayerContainer-module__IInhMG__videoArea",
  "videoElement": "PlayerContainer-module__IInhMG__videoElement",
  "vimeoContainer": "PlayerContainer-module__IInhMG__vimeoContainer",
  "withSidebar": "PlayerContainer-module__IInhMG__withSidebar",
...
const PlayerContainer = ({ videoRef, youtubeContainerRef, vimeoContainerRef, playerState, playerControls, mp4, webm, poster, captions, description, chapters, controlsType = 'minimal', onFullPlayerClick, cues = [], parsedChapters = [] })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].container} ${!playerState.isPlaying && !playerState.hasStartedOnce ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].containerClickable : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].containerDefault} ${playerState.showTranscript || playerState.showChapters ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].withSidebar : ''}`,
        onClick: handleContainerClick,
        onMouseMove: handleMouseMove,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].videoArea} ${playerState.showTranscript || playerState.showChapters ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].videoWithSidebar : ''}`,
                children: [
            ...
            controlsType === 'full' && (playerState.showTranscript || playerState.showChapters) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PlayerContainer$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].sidebarArea,
...
const FullPlayer = ({ mp4, webm, youtube, vimeo, btag, poster, captions, description, chapters, autoplay = false, muted = true })=>{
    ...
    const { cues } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useVideoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranscriptData"])(captions, description); // BEIDE!
...
//# sourceMappingURL=src_f1a1104a._.js.map