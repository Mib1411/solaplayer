...
const AudioDescIcon = (props)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                d: "M12 4a8 8 0 1 0 0 16a8 8 0 1 0 0-16zm0 2a6 6 0 1 1 0 12a6 6 0 1 1 0-12zm-1 3a1 1 0 1 1 2 0v2a1 1 0 1 1-2 0zm1 6a1.5 1.5 0 1 0 0-3a1.5 1.5 0 1 0 0 3z"
            }, void 0, false, {
                fileName: "[project]/src/components/icons.tsx",
                lineNumber: 75,
                columnNumber: 5
...
async function extractVimeoVideo(url) {
    ...
    // Placeholder für Vimeo-Implementierung
    return {
        mp4: [
            {
...
const FullPlayer = ({ mp4, webm, youtube, vimeo, btag, captions, description, chapters, autoplay, muted })=>{
    ...
    // Video source resolution with YouTube API support
    ...
    const [isEmbedPlayer, setIsEmbedPlayer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
            ...
            const resolveVideoSource = {
                "FullPlayer.useEffect.resolveVideoSource": async ()=>{
                    if (mp4) {
                        ...
                        try {
                            const sources = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$videoExtractors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractYouTubeVideo"])(youtube);
                            setVideoSources(sources);
                            if (sources.mp4?.[0]) {
                                setVideoSrc(sources.mp4[0].url);
                                setIsEmbedPlayer(sources.mp4[0].quality === 'embed');
                            }
                        } catch (error) {
                        ...
                        try {
                            const sources = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$videoExtractors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractVimeoVideo"])(vimeo);
                            setVideoSources(sources);
                            if (sources.mp4?.[0]) {
                                setVideoSrc(sources.mp4[0].url);
                                setIsEmbedPlayer(sources.mp4[0].quality === 'player');
                            }
                        } catch (error) {
                        ...
                        try {
                            ...
                            console.error('Bundestag extraction failed:', error);
                        }
                    }
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    isEmbedPlayer ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                        src: videoSrc,
                        width: "100%",
                        height: "400",
                        frameBorder: "0",
                    ...
                    !isEmbedPlayer && videoSources.mp4 && videoSources.mp4.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            marginTop: 8,
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    videoSources.mp4.map((source)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
...
_s(FullPlayer, "XPARX68kxEGTID/lyuf8hAiWzTU=", false, function() {
    return [
...
//# sourceMappingURL=src_68c5735e._.js.map